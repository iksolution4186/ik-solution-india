...
const Contact = () => {
    ...
    return (
        <div
            className=" bg-gradient-to-r from-tertiary to-primary  px-16 py-24 mt-20  md:pt-36 sm:px-4 sm:pb-16  max-w-[1535px] xlmin:mx-auto lg:px-8 lg:py-16 ">
            <ToastContainer/>
            <div className="flex items-center justify-center gap-8 md:flex-col">
                <div className="flex-1 left_section md:w-[90vw]  w-full h-full">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3412.2633484510447!2d76.1436222751071!3d31.21343256224334!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xa3101fc812144f9d%3A0xd1be063d50c96ca8!2sIk%20Solution%20EWS!5e0!3m2!1sen!2sin!4v1723271690550!5m2!1sen!2sin"
